...
4.  **Document Generation:** Each phase produces specific documents (e.g., `01_Idea.md`, `04_PRD_Generation.md`, `tasks/tasks.json`) which serve as input for subsequent phases.
...
- **Output:**
  - `01_Idea.md` file created at the project root.
...
- **Output:**
  - `02_Market_Research.md` file created at the root, containing a concise summary of the market analysis, diagrams, and brand identity.
...
- **Inputs:** `01_Idea.md` and `02_Market_Research.md`.
- **Process:**
...
- **Output:**
  - `03_Core_Concept.md` file created at the root.
...
- **Process:**
  ...
  3.  It integrates elements from `03_Core_Concept.md` into the appropriate sections of the PRD.
...
- **Output:**
  - `04_PRD_Generation.md` file created at the root.
...
- **Input:** The `04_PRD_Generation.md` file.
- **Process:**
  1.  The AI announces the update/creation of technical documentation.
  2.  **PRD Analysis:** Extracts all technologies, frameworks, APIs, etc., from `04_PRD_Generation.md`.
...
- **Inputs:**
  ...
  - Technical stack details from `02_AI-DOCS/Architecture/architecture.md` (created in phase 5) or `04_PRD_Generation.md`.
- **Process:**
...
- **Process:**
  ...
  2.  **Architecture Implementation:**
      ...
      - Configure the database schema based on `04_PRD_Generation.md` and `architecture.md`.
...
- **Inputs:**
  ...
  - `04_PRD_Generation.md` (for acceptance criteria).
...
- **Inputs:**
  ...
  - `04_PRD_Generation.md` (Section 7: Deployment Plan).
