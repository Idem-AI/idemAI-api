...
export class BrandingService {
  ...
  constructor() {
    this.repository = RepositoryFactory.getRepository<BrandingModel>(
      TargetModelType.BRANDING
    );
  }
  ...
  async generateBranding(
    userId: string,
    projectId: string,
    data: Omit<BrandingModel, "id" | "createdAt" | "updatedAt" | "projectId">
  ...
  async getBrandingsByProjectId(
    ...
    return allBrandings.filter(
      (branding: BrandingModel) => branding.projectId === projectId
    );
  }
  ...
  async updateBranding(
    ...
    brandingId: string,
    data: Partial<
      Omit<BrandingModel, "id" | "projectId" | "createdAt" | "updatedAt">
    >
  ): Promise<BrandingModel | null> {
    // Repository's update method handles updatedAt internally
    const updatePayload: Partial<
      Omit<BrandingModel, "id" | "createdAt" | "updatedAt">
    > = data;
