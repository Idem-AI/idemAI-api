...
- No custom CSS, extensive Chart.js integration for financial visualization
...
- Charts: extensive Chart.js integration for all financial data
...
- Extensive Chart.js integration for all financial metrics
...
OUTPUT FORMAT:
Return only the minified HTML section with extensive embedded Chart.js code, ready for business plan integration.
`;
